...
export type EventBoardOptions = {
     ...
     * Su posición viene horneada en el .glb con las coordenadas de Genesis Plaza,
     * así que en otra escena vas a querer `titleTransform` o directamente `false`.
     * Default: false.
     */
    showTitle?: boolean
    /** Transform del cartel de título. Se ignora si `showTitle` es false. */
...
export async function initLiveEventBoard(
    ...
    pointerEventsSystem.onPointerDown(
        ...
        (e) => {
            ...
            startEventInteraction(eventBoardRoot)
        }
    )
